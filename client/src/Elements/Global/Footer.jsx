...
export default function Header() {
    ...
    return (
      ...
      <footer className="w-full bg-back">
        <ul className="flex justify-between w-full pl-6 pr-5 py-10 text-center">
          <li className="w-2/3 flex items-center">
            <a className="flex items-center" href="/">
              <h1 className="text-3xl font-semibold font-serif">ИгроваяЛавка</h1>
            </a>
          </li>
          <li className="flex items-center text-sm font-medium"><a href="/Example">Политика конфиденциальности</a></li>
          <li className="flex items-center text-sm font-medium"><a href="/Example">Написать в поддержку</a></li>
          <li className="flex items-center text-sm font-medium"><a href="/Example">Связь с разработчиками</a></li>
        </ul>
